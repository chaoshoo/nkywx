var member = {
	addMember : function(flag){
		...
		returnflag = "no";//标志位，当bynotime，表示不return,byyestime则return;
	...
	openEmail : function(){
		...
		var memberId = $("#memberId").val();
		if(memberId==""){
			$("#registerMemberFirstEmail").html("Please add the basic information，Set email again！");// 因为是修改成员信息，必须要有成员ID
		}else{
