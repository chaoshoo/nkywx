...
<!-- 
  <dd><a class="react" href="#">
    <div> <i class="text-icon order-jiudian order-icon">about</i>预about号 <span class="green">20151544</span>
    </div> 
...
<dl class="list">
  <dd><a class="react" href="#">
    <div> <i class="text-icon order-lottery order-icon">letter</i>其他letter息 </div>
		...
		success:function(data){
			...
			$.each(data, function(i, item){
				yuyuelisthtml += '<dd><a class="react" href="#">'
								+'<div> <i class="text-icon order-jiudian order-icon">about</i>预about时间 <span class="green">'+item.ORDER_TIMESTR+'</span>';
