...
<dl class="list"  style=" border-top:none;border-bottom:none;">
  <dd><a class="react" href="#" >
    <div class="more more-weak" onclick="yuyue();"> <i class="text-icon order-jiudian order-icon">about</i>立即预about<!-- <span class="more-after"></span> --> 
    </div>
    </a> <span class="yuyue"></span> </dd>
</dl>
<dl class="list"  style=" border-top:none;border-bottom:none;">
  <dd><a class="react" href="#" onclick="member();">
    <div class="more more-weak"> <i class="text-icon order-lottery order-icon">home</i>home庭成员 </div>
