...
import com.net.singleton.pub.SysSequence;
import com.net.util.BeanContext;
public final class SysId {
	...
	public static SysId getInstance() {
		...
		if (sysDb == null) {
			sysDb = (SysDb) BeanContext.getBean("sysDb");
			DataSource dataSource=(DataSource)BeanContext.getBean("dataSource");
...
//					log.debug("GET SEQ OUTPUT PARAMS !start = " + start + ";end= " + end + ";id= " + id);
	...
	public static String getNextYueCode() throws Exception{
		return "Y"+getInstance().getSeq("SEQ_YUE_ID");
	}
}