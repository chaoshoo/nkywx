...
public class SysDb {
	...
	private static Log log = LogFactory.getLog(SysDb.class);
	...
	private static String SqlSequenceQuery2 = " */ class_name, seq_id, step_value, min_value, max_value " +
			"FROM ioid_sequence_t WHERE 2=2 and class_name = ? "+
			"FOR UPDATE";
	
	private static String SqlSequenceUpdate = "UPDATE /* " ;
	
	private static String SqlSequenceUpdate2 = " */ ioid_sequence_t SET seq_id = ? " +
	"WHERE  2=2 and  class_name = ?";
